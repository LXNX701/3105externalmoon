...
struct ThreeOneOSFiveApp: App {
    ...
    @StateObject private var moonAuth = MoonAuthManager()
    ...
    var body: some Scene {
        WindowGroup {
            ZStack {
                // Moon Place: el acceso con KeyAuth es la única entrada visible.
                // La interfaz original del 3105 queda oculta (solo la lógica de
                // parches/exploit se reutiliza desde MoonPlaceView).
                if moonAuth.isAuthenticated {
                    MoonPlaceView(auth: moonAuth)
